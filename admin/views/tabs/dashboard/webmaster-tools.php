...
printf(
	...
	esc_html__( 'Get your Bing verification code on the %1$sBing Webmaster Tools site%2$s.', 'wordpress-seo' ),
...
printf(
	/* translators: 1: link open tag; 2: link close tag. */
	esc_html__( 'Get your Google verification code on the %1$sGoogle Webmaster Central site%2$s.', 'wordpress-seo' ),
...
printf(
	/* translators: 1: link open tag; 2: link close tag. */
	esc_html__( 'Get your Yandex verification code on the %1$sYandex Webmaster Tools site%2$s.', 'wordpress-seo' ),
